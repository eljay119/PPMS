    ...
    <div class="container py-4">
        <div class="card shadow">
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-light text-dark">PR No.: {{ $appProject->pr_no ?? 'N/A' }}</span>
            </div>
                                ...
                                <table class="table table-striped">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>{{ $appProject->quarter ?? 'N/A' }}</td>
                                        </tr>
                                        <tr>
                                            <th>Category</th>
                                            <td>{{ $appProject->category->name ?? 'N/A' }}</td>
                                        </tr>
                                        <tr>
                                            <th>Mode of Procurement</th>
                                            <td>{{ $appProject->modeOfProcurement->name ?? 'N/A' }}</td>
                                        </tr>
                                        <tr>
                                            <th>Fund Source</th>
                                            <td>{{ $appProject->sourceOfFund->name ?? 'N/A' }}</td>
                                        </tr>
                                        <tr>
                                            <th>End User</th>
                                            <td>{{ $appProject->endUser->name ?? 'N/A' }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                ...
                                <table class="table table-striped">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>{{ $appProject->supplier ?? 'N/A' }}</td>
                                        </tr>
                                        <tr>
                                            <th>Remarks</th>
                                            <td>{{ $appProject->remarks ?? 'N/A' }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <ul class="list-group list-group-flush mt-2">
                                                    <li
                                                        ...
                                                        <span
                                                            class="fw-bold">{{ $appProject->approval_date ?? '' }}</span>
                                                    </li>
                                                    <li
                                                        class="list-group-item d-flex justify-content-between align-items-center">
                                                        <span>Opening Date:</span>
                                                        <span
                                                            class="fw-bold">{{ $appProject->opening_date ?? '' }}</span>
                                                    </li>
                                                    <li
                                                        class="list-group-item d-flex justify-content-between align-items-center">
