...
class AppProject3Controller extends Controller
{
    ...
    {
        $projects = AppProject::with(['app', 'category', 'status', 'sourceOfFund', 'endUser', 'modeOfProcurement'])->get();
    ...
    public function create()
    {
        ...
        return view('budget_officer.submitted_projects.create', compact('apps', 'categories', 'statuses', 'funds', 'users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('budget_officer.submitted_projects.index')->with('success', 'APP Project created successfully!');
    }

    // Show a specific APP Project
    public function show(AppProject $appProject)
    {
        return view('budget_officer.submitted_projects.show', compact('appProject'));
    }
    ...
    public function edit(AppProject $appProject)
    {
        ...
        return view('budget_officer.submitted_projects.edit', compact('appProject', 'apps', 'categories', 'statuses', 'funds', 'users'));
    }
    ...
    public function update(Request $request, AppProject $appProject)
    {
        ...
        return redirect()->route('budget_officer.submitted_projects.index')->with('success', 'APP Project updated successfully!');
    }
    ...
    {
        $appProject->delete();
        return redirect()->route('budget_officer.submitted_projects.index')->with('success', 'APP Project deleted successfully!');
    }
}
